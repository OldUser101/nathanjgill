...
export default async function ProjectLoader({ params }: ProjectLoaderProps) {
    const { slug } = await params;
    ...
    const projectWithCdn = ResolveProjectCdnUrls(project);

    return (
        <ProjectPage project={projectWithCdn}/>
    );
}
